# genpark-verified-merchant-review-citation-synthesizer-skill
...
**genpark-verified-merchant-review-citation-synthesizer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise e-commerce pipelines.

> **Executive Capability**: Verified merchant review citation synthesizer & grounded pros/cons (Perplexity)
...
result = client.synthesize_product_reviews_with_citations()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-verified-merchant-review-citation-synthesizer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-verified-merchant-review-citation-synthesizer-skill/mcp_server.py"]
    }
  }
}
```
